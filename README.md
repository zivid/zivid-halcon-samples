...
Samples indicated by **(cpp)** are written in C++, while samples written in HDevelop is indicated by **(hdev)**.  
...
- **Camera**
  - **Basic**
    ...
    - **CaptureViaGenICam** ([**cpp**][cpp-captureViaGenICam-url]) - Capture and save a point cloud, with colors, using GenICam interface and Halcon C++ SDK.
    - **CaptureViaZivid** ([**cpp**][cpp-captureViaZivid-url]) - Capture a point cloud, with colors, using Zivid SDK, transform it to a Halcon point cloud and save it using Halcon C++ SDK.
  - **InfoUtilOther**
