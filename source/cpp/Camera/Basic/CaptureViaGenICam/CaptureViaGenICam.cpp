...
void setColorsInObjectModel3D(HalconCpp::HObjectModel3D &objectModel3D,
                              ...
                              const HalconCpp::HImage &zReduced)
{
    ...
    objectModel3D.SetObjectModel3dAttribMod(HalconCpp::HTuple("red"),
                                            "points",
                                            RGB.AccessChannel(1).GetGrayval(rows, cols));
    objectModel3D.SetObjectModel3dAttribMod(HalconCpp::HTuple("green"),
                                            "points",
                                            RGB.AccessChannel(2).GetGrayval(rows, cols));
    objectModel3D.SetObjectModel3dAttribMod(HalconCpp::HTuple("blue"),
                                            "points",
                                            RGB.AccessChannel(3).GetGrayval(rows, cols));
}
...
int main()
{
    try
    {
        ...
        HalconCpp::OpenFramegrabber("GenICamTL",
                                    1,
                                    1,
                                    0,
                                    0,
